 ...
 */
 class Rebelmouse_Widget extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		/* RebelMouse Render*/
        $this->render( array('show_stream' => $this->show_stream, 'site_name' => $this->site_name
                            , 'cols' => $this->cols, 'skip' => $skip, 'width' => $this->width
                            , 'height' => $this->height
    ...
    public function render( $args ) {
        $r = wp_parse_args( $args
                            , array('show_stream' => True
                                    ,'site_name' => 'rebelmouse'
                                    ,'cols' => '1'
                                    ,'skip' => ''
                                    ,'width'=> ''
                                    ,'height' => '0'
        ...
        <style>.rebelmouse-embed { overflow-y:hidden;-ms-overflow-y: hidden;padding:0;magin:0; }iframe::-webkit-scrollbar { display: none; } </style>
        <?php
        if  ( $r['show_button'] )
	...
	function form( $instance ) {
        ...
        <h4 style="border-bottom: solid 1px #CCC;">RebelMouse Embed Stream</h4>
		...
		<p>
            ...
            <br><small>(each column is 257 pixels wide)</small>
		</p>
 ...
 *     'cols' (int) - Number of columns to show (the final width is 257px for columns number)
 *     'skip' (String) - Element to hide in the stream: about-site, network, also-on-rm, share-frontpage
 *     'height' (int) - height of the iframe
 *     'show_button' (int) - if you want to show the follow button, 1 to show, 0 to hide.
 *     'theme_button' (int) - Theme for the button, could be "dark" or "clear".
 *
